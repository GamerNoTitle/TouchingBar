...
public enum BuiltInPresets {
    ...
    public static func systemFunctions() -> TouchBarPreset {
        let items: [TouchBarItemConfiguration] = [
            ...
            .init(label: "F5", symbolName: "light.max", width: .compact, action: ActionSpec(kind: .keyboardBacklight, value: "on")),
            .init(label: "F6", symbolName: "light.min", width: .compact, action: ActionSpec(kind: .keyboardBacklight, value: "off")),
